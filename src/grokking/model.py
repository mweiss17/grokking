...
class TransformerModel(nn.Module):
    ...
    def __init__(self, ntoken: int, d_model: int, nhead: int, d_feedforward: int,
        ...
        transformer_layers = TransformerEncoderLayer(d_model, nhead, dim_feedforward=d_feedforward, dropout=dropout, **kwargs)
    ...
    def forward(self, src: Tensor) -> Tensor:
        ...
        pred = torch.log_softmax(output[-1], 1)
        return pred
...
# Alternative implementation by changing transformer decoder layers---------------------------
# custom decoder without memory
